...
// সাইট ইউআরএল। রুট ফোল্ডারের এড্রেস দিতে হবে। এখানে এড্রেসটি অটোজেনারেট করবে।
...
*/
// ইউআরএল এর শেষে মেনুয়াল এক্সটেনশান ব্যবহার করুন। যেমন .html, .php, .kawsar, .sani
$config['url_suffix'] = "";
...
|
*/
// নিজস্ব কোন লাইব্রেরী নামের প্রিফিক্স। যদি কোন লাইব্রেরীকে এক্সটেন্ড করতে হয় তাহলেও ব্যাবহার করা যাবে। যেমন কোডইগ্নিটারের 
// কোর form লাইব্রেরীটি এক্সটেন্ড করতে পারেন My_form নাম দিয়ে।
...
|
*/
// ইউআরএল ইঞ্জেকশান প্রিভেন্ট করতে ব্যবহার করতে হয়। নিজস্ব ফরমেট ইচ্ছে করলে ব্যবহার করা যাবে।
